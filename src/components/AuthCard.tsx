// คอมโพเนนต์ AuthCard ใช้เป็นกล่องกลางห่อฟอร์มล็อกอิน / สมัครสมาชิก
...
export default function AuthCard({
  ...
  return (
    ...
    <div className="w-full max-w-xl rounded-3xl bg-white shadow-xl ring-1 ring-black/5 p-6 md:p-8">
      {/* ส่วนนี้จะแสดงคอนเทนต์ที่ถูกส่งเข้ามาผ่าน AuthCard
          เช่น แท็บสลับ Login/Register, ช่องกรอก TextField ฯลฯ */}
      {children}
    </div>
  );
}
